...
|---|---|---|---|
| 1 | FRESH_LINE_UNGATED - the "jauna partija" line of 232/233/234 sits inside the v2.8 fresh flag (today it is inside `{% if contact.P1_NAME %}` only) | `presend.py` (MAIN command 5: "so it cannot be forgotten") | BLOCKED - the flag is not in the contract yet |
