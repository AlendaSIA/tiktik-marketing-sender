"""Pins contract v2.8 (d1f506313dc1) on the prepared templates 232/233/234 - the READER's part (MAIN 2026-09-25
17:05): P2 display, P4 display, P6. Standard library only, no network. The image does not carry templates/, so
this file skips there, like test_draft_test.py."""
import json
import os
import re
import sys
...
FILES = {232: "winback_2.html", 233: "winback_3.html", 234: "lost_quarterly.html"}
...
def tpl(tid):
    return open(os.path.join(TEMPLATES, FILES[tid]), encoding="utf-8").read()
